...
@Autowired
CommentRepository commentRepository; // commentRepository에 객체 주입
    @Test
    @DisplayName("특정 게시글의 모든 댓글 조회") // 서비스테스트에서는 메서드명을 직접 변경하였지만 이 어노테이션을 사용하면 메서드 이름을 그대로 둔채 테스트 이름을 바꿀수있음
